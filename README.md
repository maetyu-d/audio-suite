...
Scrubber enables simple, gestural tape-against-tape-head-like scrubbing of audio, with a few tricks up its sleeve like multiple playback heads and a vsarispeed mode (tape can manipulated while playing back at any speed and the effects are cumulative).
